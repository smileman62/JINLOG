...
description: "안녕하세요? 이번 시간에는 React에서 컴포넌트를 어떻게 설계할 것인지에 대한 이야기를 해보려고 합니다. React 프로젝트를 진행하다 보면 다음과 같은 컴포넌트를 쉽게 만나게 됩니다. API 호출 상태 관리 UI 렌더링 이벤트 처리 아마 컴포…"
date: "2026-03-09"
tags: ["react"]
published: true
cover: "/images/blog/4_1.jpg"
---
![img](/images/blog/4_2.png)
