...
description: "React 렌더링 최적화 실전 Profiler부터 memo까지 제대로 사용해보자! React에서 성능 최적화를 이야기할 때 가장 많이 나오는 키워드는 useMemo, useCallback, React.memo입니다. 하지만 이들을 어떻게 올바르게…"
date: "2026-04-27"
tags: ["react"]
published: true
cover: "/images/blog/16_1.png"
---
