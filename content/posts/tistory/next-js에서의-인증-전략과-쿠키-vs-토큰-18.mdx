...
description: "Next.js에서 인증이 중요한 이유 Next.js에서 인증이 조금 까다롭게 느껴지는 이유는 단순히 \\\"로그인 여부를 확인하는 코드\\\"만 작성하면 끝나는 구조가 아니기 때문입니다. Next.js는 Server Components, Client Com…"
date: "2026-05-10"
tags: ["nextjs"]
published: true
---
...
const protectedRoutes = ['/dashboard', '/mypage', '/admin'];
